...
<div class="section-title">
          <h2>section title nya dari PIR Approval Form jdi PIR Form</h2>
</div>
...
<!--Submission-->
<form method="POST" action="{{url('/work-user/postimplementation/create-pir-store/'.$id->id)}}" enctype="multipart/form-data">
<div id="SubmissionFSD" class="tabcontent">
 @csrf
    <div class="">
            ...
            <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="pir_file">Choose File</label>
                    <div class="custom-file custom-file col-sm-10">
                        <input type="file" class="custom-file-input" id="pir_file" name="pir_file" onchange="return fileValidation()" required>
            ...
            <script>
                    ...
                    function fileValidation() { 
                        var fileInput =  
                            document.getElementById('pir_file'); 
