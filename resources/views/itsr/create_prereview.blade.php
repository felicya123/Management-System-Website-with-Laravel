...
<div id="ITSR" class="tabcontent" style="display:block">
        ...
        <div class="form-group row">
            <label for="itsr_title" class="col-sm-2 col-form-label">Title ITSR</label>
            <div class="col-sm-10">
            <input type="text" name="itsr_title" class="form-control" value="{{$itsr->itsr_title}}" readonly>
            </div>
        </div>
...
<form  method="POST" action="{{url('/work-ba/itsr/create-pre-review-store/'.$id->id)}}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="">
        ...
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="file_pre_review">Choose file</label>
            <div class="custom-file custom-file col-sm-10">
                <input type="file" class="custom-file-input" id="file_pre_review" name="file_pre_review" onchange="return fileValidation()" required>
        ...
        <script>
            $('#file_pre_review').on('change',function(){
            ...
            function fileValidation() { 
                var fileInput =  
                    document.getElementById('file_pre_review'); 
