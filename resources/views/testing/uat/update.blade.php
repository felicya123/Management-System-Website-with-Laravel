...
<h3>Document Attachment</h3>
        ...
        @endif
        @if($a->uat_report_file != null)
        <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="inputGroupFile04">UAT Execution Report File</label>
            <div class="custom-file custom-file col-sm-10">
                <a href="/files/uat-report/{{$itsr->itsr_no}}" target="_blank"><button class="btn">view</button></a>
            </div>
        </div>
        @endif
        @break
...
<!--Submission-->
<form method="POST" action="{{url('/work-user/testing/update-uat-store/'.$id->id)}}" enctype="multipart/form-data">
<div id="SubmissionFSD" class="tabcontent">
    @csrf
        <div class="">
            ...
            <div class="form-group row">
            <label for="status_itsr_ba" class="col-sm-2 col-form-label">Status UAT Execution</label>
            <div class="col-sm-10">
                <div class="col-sm">
                    <div class="btn-group">
                        <input type="radio" name="status_itsr" value="UAT Pending" id="noCheck" required>Pending
                        <input type="radio" name="status_itsr" value="UAT On Progress" id="noCheck" required>On Progress
                        <input type="radio" name="status_itsr" value="UAT Done" id="yesCheck" required>Done
                    </div>                    
                </div>
            </div>
            </div> 
            ...
            <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="uat_file">Choose file</label>
                    <div class="custom-file custom-file col-sm-10">
                        <input type="file" class="custom-file-input" id="uat_file" name="uat_file"  onchange="return fileValidation()" required>
                ...
                <script>
                    ...
                    function fileValidation() { 
                        var fileInput =  
                            document.getElementById('uat_file'); 
