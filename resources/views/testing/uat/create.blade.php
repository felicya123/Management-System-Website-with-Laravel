...
<!--Submission-->
@foreach($wb as $a)
@if(Auth::user()->division == "User" &&  $a->description == "Waiting for UAT Test Result to be submitted by User")
<form method="POST" action="{{url('/work-user/testing/create-uat-tr-store/'.$id->id)}}" enctype="multipart/form-data">
@elseif(Auth::user()->division == "User" &&  $a->description == "Waiting for UAT Test Result to be revised by User")
<form method="POST" action="{{url('/work-user/testing/create-uat-tr-store/'.$id->id)}}" enctype="multipart/form-data">
@else
<form method="POST" action="{{url('/work-user/testing/create-uat-tp-store/'.$id->id)}}" enctype="multipart/form-data">
@endif
@endforeach
