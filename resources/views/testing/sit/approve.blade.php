...
@foreach($wb as $a)
@if(Auth::user()->division == "IT_AppsManager" && $a->description == "Waiting for SIT Test Plan to be approved by IT Apps Manager")
<form method="POST" action="{{url('/work-am/testing/approve-sit-tp-am-store/'.$id->id)}}" enctype="multipart/form-data">
@elseif(Auth::user()->division == "IT_Owner" && $a->description == "Waiting for SIT Test Plan to be approved by IT Owner")
<form method="POST" action="{{url('/work-owner/testing/approve-sit-tp-owner-store/'.$id->id)}}" enctype="multipart/form-data">
@elseif(Auth::user()->division == "IT_AppsManager" && $a->description == "Waiting for SIT Test Result to be approved by IT Apps Manager")
<form method="POST" action="{{url('/work-am/testing/approve-sit-tr-am-store/'.$id->id)}}" enctype="multipart/form-data">
@elseif(Auth::user()->division == "IT_Owner" && $a->description == "Waiting for SIT Test Result to be approved by IT Owner")
<form method="POST" action="{{url('/work-owner/testing/approve-sit-tr-owner-store/'.$id->id)}}" enctype="multipart/form-data">
@endif
@endforeach
