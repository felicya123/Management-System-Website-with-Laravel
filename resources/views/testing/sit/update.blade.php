...
<!--Submission-->
<form method="POST" action="{{url('/work-ba/testing/update-sit-store/'.$id->id)}}" enctype="multipart/form-data">
<div id="SubmissionFSD" class="tabcontent">
    @csrf
        <div class="">
            ...
            <div class="form-group row">
            <label for="status_itsr_ba" class="col-sm-2 col-form-label">Status SIT Execution</label>
            <div class="col-sm-10">
                <div class="col-sm">
                    <div class="btn-group">
                        <input type="radio" name="status_itsr" value="SIT Pending" id="noCheck" required>Pending
                        <input type="radio" name="status_itsr" value="SIT On Progress" id="noCheck" required>On Progress
                        <input type="radio" name="status_itsr" value="SIT Done" id="yesCheck" required>Done
                    </div>                    
                </div>
            </div>
            </div> 
