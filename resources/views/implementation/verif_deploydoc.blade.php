...
<div class="section-title">
          <h2>Deployment Verification Form</h2>
</div>
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Approval')">Verification</button>
</div>
...
<h3>Document Attachment</h3>
        <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="inputGroupFile04">ITSR/BRD File</label>
            <div class="custom-file custom-file col-sm-10">
                <a href="/files/{{$itsr->itsr_no}}" target="_blank"><button class="btn" >view</button></a>
            </div>
        </div>
...
@foreach($wb as $a)
@if(Auth::user()->division == "IT_PMO" && $a->description == "Waiting for Deployment Doc to be verification by IT PMO")
<form method="POST" action="{{url('/work-pmo/implementation/verif-deploydoc-pmo-store/'.$id->id)}}" enctype="multipart/form-data">
@endif
@endforeach
 ...
 @csrf
    ...
    <div class="">
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="col-sm-12">
                    <label for="comment_itsr" >SDLC Document</label>
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="itsr_status" value="1"> ITSR
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="itsr_assess_status" value="1"> ITSR Assessment
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="fsd_status" value="1"> FSD
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="tsd_status" value="1"> TSD
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="sit_tc_status" value="1"> SIT Test Script/Case/Scenario
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="sit_tp_status" value="1"> SIT Test Plan
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="sit_tr_status" value="1"> SIT Test Result
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="sat_tp_status" value="1"> SAT Test Plan
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="sat_tr_status" value="1"> SAT Test Result
                </div>
            </div>
            <div class="form-group row">
                
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="uat_tc_status" value="1"> UAT Test Script/Case/Scenario
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="uat_tp_status" value="1"> UAT Test Plan
                </div>
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="uat_tr_status" value="1"> UAT Test Result
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="checkbox" aria-label="Checkbox for following text input" name="memodeploy_status" value="1"> Memo Deploy
                </div>
            </div>
